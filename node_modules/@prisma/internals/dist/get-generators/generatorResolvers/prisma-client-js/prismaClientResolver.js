...
`;
      ...
      console.info(`\u2714 Created ${(0, import_colors.bold)((0, import_colors.green)("./package.json"))}`);
    }
    ...
    if (process.platform === "win32" && await (0, import_isYarnUsed.isYarnUsed)(baseDir)) {
      ...
      throw new Error(
        `Could not resolve ${missingCli(`${(0, import_colors.bold)("prisma")} and `)}${(0, import_colors.bold)(
          ...
          `${(0, import_colors.bold)((0, import_colors.green)(`${(0, import_getPackageCmd.getPackageCmd)(baseDir, "add", "prisma", "-D")}`))} and `
        )}${(0, import_colors.bold)((0, import_colors.green)(`${(0, import_getPackageCmd.getPackageCmd)(baseDir, "add", "@prisma/client")}`))}, and rerun ${(0, import_colors.bold)(
...
Please try to install it by hand with ${(0, import_colors.bold)(
          (0, import_colors.green)(`${(0, import_getPackageCmd.getPackageCmd)(baseDir, "add", "@prisma/client")}`)
