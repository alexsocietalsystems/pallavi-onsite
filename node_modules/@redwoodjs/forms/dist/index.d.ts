 ...
 */
declare const Label: ({ name, children, errorClassName, errorStyle, className, style, ...rest }: LabelProps) => React.JSX.Element;
 ...
 */
declare const FieldError: ({ name, ...rest }: FieldErrorProps) => React.JSX.Element | null;
