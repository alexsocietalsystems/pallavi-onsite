...
type WrapperType<WTProps> = (props: WTProps & {
    children: ReactNode;
}) => ReactElement | null;
type SetProps<P> = P & {
 ...
 */
export declare function Set<WrapperProps>(props: SetProps<WrapperProps>): React.JSX.Element | null;
type PrivateProps<P> = Omit<SetProps<P>, 'private' | 'unauthenticated' | 'wrap'> & {
    /** The page name where a user will be redirected when not authenticated */
    unauthenticated: string;
    wrap?: WrapperType<P> | WrapperType<P>[];
};
export declare function Private<WrapperProps>(props: PrivateProps<WrapperProps>): React.JSX.Element;
export {};
